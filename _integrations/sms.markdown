...
If the integration is used with the Open Peer Power Operating System, then version [3.6](https://github.com/OpenPeerPower/oppos/releases/tag/3.6) or higher is required.
